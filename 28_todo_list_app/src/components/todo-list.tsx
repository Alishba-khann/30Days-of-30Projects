...
export default function TodoList() {
  ...
  return (
    <div className="flex flex-col items-center justify-center h-screen bg-stone-400">
      {/* Center the todo list within the screen */}
      <div className="w-full max-w-md bg-yellow-400 dark:bg-slate-950 shadow-lg rounded-lg p-6">
        {/* Header with title */}
        <h1 className="text-2xl font-bold mb-4 text-black dark:text-gray-200">
          Todo List
        </h1>
        ...
        <div className="flex items-center mb-4">
          ...
          <Button
            onClick={addTask}
            className="bg-black hover:bg-stone-700 text-white font-medium py-2 px-4 rounded-md"
          >
            Add
          </Button>
        </div>
            ...
            >
              ...
              <div className="flex items-center">
                {editingTaskId === task.id ? (
                  ...
                  <Button
                    onClick={updateTask}
                    className="bg-black hover:bg-stone-700 text-white font-medium py-1 px-2 rounded-md mr-2"
                  >
                    Save
                  </Button>
                ) : (
                ...
                <Button
                  ...
                  className="bg-red-600 hover:bg-white border hover:border-red-600 text-white hover:text-red-700 font-medium py-1 px-2 rounded-md"
                >
                  Delete
                </Button>
              </div>
