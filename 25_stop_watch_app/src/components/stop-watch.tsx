...
export default function StopWatch() {
  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-stone-300 p-4">
      <Card className="w-full bg-orange-400 max-w-lg">
        <CardHeader className="flex flex-col items-center justify-center">
          <CardTitle className="text-5xl text-blue-950 font-bold">Stopwatch</CardTitle>
        ...
        <CardContent className="flex flex-col items-center justify-center gap-8 p-4">
          ...
          <div className="text-8xl text-blue-950 font-bold">
          ...
          <div className="flex gap-4">
            <Button
              ...
              className="px-6 py-2 text-lg bg-black font-medium rounded-lg"
            >
