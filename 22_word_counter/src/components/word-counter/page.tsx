...
export default function WordCounter() {
  ...
  return (
    <div className="flex flex-col items-center justify-center bg-slate-500 h-screen gap-6">
      <Card className="w-full border-blue-800 max-w-md">
        <CardHeader className="text-center text-blue-900 justify-center flex flex-col">
