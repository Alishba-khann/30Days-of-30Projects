...
export default function PomodoroTimer() {
  ...
  return ( 
    <div className="flex flex-col items-center justify-center min-h-screen bg-red-900 dark:bg-white">
      {/* Center the Pomodoro timer card within the screen */}
      <Card className="w-full max-w-md p-6 bg-black dark:bg-white shadow-lg rounded-lg">
        <div className="flex flex-col text-white  items-center justify-center gap-6">
          <h1 className="text-4xl text-white font-bold">Pomodoro Timer</h1>
          <p className="text-white">A timer for the Pomodoro Technique.</p>
          ...
          <div className="flex items-center gap-4">
            ...
            <Button className ="text-black" variant="outline" size="icon" onClick={handleStartPause}>
            ...
            <Button className ="text-black" variant="outline" size="icon" onClick={handleReset}>
          ...
          <div className="p-2">
            ...
            <AlertDialog>
              <AlertDialogTrigger asChild>
                <Button className="bg-red-600 hover:bg-red-950">What is Pomodoro Technique?</Button>
              </AlertDialogTrigger>
              <AlertDialogContent className="w-full bg- text-white max-w-2xl p-4 md:p-6">
                <AlertDialogHeader>
                  <AlertDialogTitle>
...
`}{" "}
                ...
                <AlertDialogFooter>
                  <AlertDialogCancel className="bg-red-600 hover:bg-red-900">Cancel</AlertDialogCancel>
                  <AlertDialogAction className="bg-red-600 hover:bg-red-900">Continue</AlertDialogAction>
                </AlertDialogFooter>
              </AlertDialogContent>
            </AlertDialog>
          </div>
