...
export default function GitHubProfileViewer() {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-slate-900 py-8">
      <Card className="w-full max-w-3xl p-6 space-y-4 shadow-lg rounded-lg bg-slate-50">
        <CardHeader className="text-center">
          <CardTitle className="text-3xl text-slate-600 font-bold mb-2">
        ...
        <form onSubmit={handleSubmit} className="mb-8 px-6">
          <div className="flex items-center gap-4">
            ...
            <Button
              type="submit"
              disabled={loading}
              className="px-4 py-2 bg-slate-900 hover:bg-black text-white rounded-md"
            >
