...
export default function CurrencyConverter() {
  ...
  return (
    <div className="flex flex-col items-center justify-center bg-red-300 h-screen bg-background">
      <Card className="w-full max-w-md bg-red-200 p-6 space-y-4">
        <CardHeader className="text-center">
          <CardTitle className="text-3xl font-serif font-extrabold">
            Currency Converter
          </CardTitle>
        ...
        <CardFooter>
          ...
          <Button
            type="button"
            className="w-full bg-stone-800 hover:bg-black"
