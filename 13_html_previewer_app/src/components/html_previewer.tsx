...
export default function HTMLPreview() {
  ...
  return (
    <div className="flex flex-col items-center justify-center h-screen bg-pink-300 text-foreground">
      {/* Center the HTML previewer card within the screen */}
      <div className="w-full max-w-2xl p-6 rounded-lg bg-gray-200 shadow-lg bg-card">
        <h1 className="text-2xl font-bold mb-4 text-pink-700 text-center">HTML Previewer</h1>
        ...
        <div className="grid gap-4">
          ...
          <div className="flex justify-center">
            <div className="flex gap-2 ">
              <Button className=" bg-pink-700 hover:bg-pink-900" onClick={handlePreview}>Generate Preview</Button>
              <Button className=" bg-pink-700  hover:bg-pink-900" onClick={handlePasteHtml}>Paste HTML</Button>
            </div>
          </div>
          {/* Div to display the HTML preview */}
          <div className="p-4 rounded-lg borderborder-input bg-background text-foreground">
