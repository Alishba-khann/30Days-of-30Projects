...
const candleColors = ['#FFFF00', '#00FF00', '#13B7CD', '#CD1357', '#B113D1']
const balloonColors = ['#D19F13', '#D19F13', '#D19F13', '#D19F13', '#D19F13']
...
export default function BirthdayWish() {
  ...
  return (
    ...
    <div className="min-h-screen bg-white flex items-center justify-center p-4">
      ...
      >
        {/* Birthday card */}
        <Card className="mx-auto overflow-hidden transition-all duration-300 ease-in-out hover:shadow-xl border-2 bg-black border-black">
          {/* Card header with birthday message */}
          <CardHeader className="text-center">
            <CardTitle className="text-4xl font-bold text-sky-300">Happy Birthday!</CardTitle>
            <CardDescription className="text-2xl font-semibold text-gray-400">Alishba Khan</CardDescription>
            <p className="text-lg text-orange-600">11<sup>th</sup> October</p>
          </CardHeader>
          ...
          <CardFooter className="flex justify-center">
            <Button 
              className="bg-yellow-300 text-white hover:bg-gray-800 transition-all duration-300"
              onClick={celebrate}
