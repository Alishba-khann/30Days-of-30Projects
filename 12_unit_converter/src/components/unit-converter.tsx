...
export default function UnitConverter() {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-yellow-200 dark:bg-gray-900">
      ...
      <div className="max-w-md w-full p-6 bg-card bg-yellow-100 text-violet-900 rounded-lg shadow-lg">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <Button
            type="button"
            className="col-span-2 bg-purple-600 text-primary-foreground hover:bg-purple-950 focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring"
