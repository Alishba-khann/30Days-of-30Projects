...
export default function URLShortener() {
  ...
  return (
    <div className="flex flex-col items-center justify-center h-screen bg-gradient-to-br from-green-800 to-secondary">
      <div className="max-w-md w-full space-y-4 p-6 rounded-lg bg-background shadow-lg">
        <div className="space-y-2 text-center">
          <h1 className="text-3xl text-green-900 font-bold">URL Shortener</h1>
        ...
        <form className="space-y-4" onSubmit={handleSubmit}>
          <div className="relative">
            <Input
              ...
              className="pr-16 hover:border-green-300"
              required
            />
            <Button
              type="submit"
              className={`absolute top-1/2 right-2 -translate-y-1/2 ${
                loading ? "bg-gray-400" : "bg-gray-500 hover:bg-slate-600"
              }`}
              disabled={loading}
            >
