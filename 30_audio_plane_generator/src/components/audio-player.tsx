...
const AudioPlayer: React.FC<AudioPlayerProps> = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center h-screen bg-gray-200 text-purple-900">
      <div className="max-w-md w-full space-y-4">
        <div className="flex items-center  justify-between">
          <h1 className="text-2xl text-purple-900 font-bold">Audio Player</h1>
          <label className="flex items-center cursor-pointer">
            <UploadIcon className="w-5 h-5 mr-2 text-purple-950" />
            <span className="text-purple-900">Upload</span>
            <input
              type="file"
              accept="audio/*"
              multiple
        ...
        <Card>
          <CardContent className="flex flex-col items-center bg-purple-300 justify-center gap-4 p-8">
            <Image
              src="/music.svg"
              alt="Album Cover"
              width={100}
